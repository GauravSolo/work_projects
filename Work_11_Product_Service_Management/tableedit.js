...
!(function (t) {
    ...
    t.fn.Tabledit = function (e) {
        function n(e) {
            var n = i.find(".tabledit-input").serialize() + "&action=" + e +"&status="+document.querySelector("#activelistbox").value +"&type="+document.querySelector("#selectbox").value,
                a = d.onAjax(e, n);
            if (a === !1) return !1;
            var l = t.post(
                d.url,
        ...
        var i = this,
            a = {
                ...
                buttons: {
                    ...
                    delete: { class: "btn btn-sm btn-default", html: '', action: "delete" },
                ...
                onDraw: function () {},
                onSuccess: function () {console.log("2");},
                onFail: function () {},
                onAlways: function () {console.log("3");},
                onAjax: function () {console.log("4");},
            },
            d = t.extend(!0, a, e),
            s = "undefined",
            o = "undefined",
