  ...
  "fnRowCallback" : function(nRow, aData, iDisplayIndex){
    ...
    "drawCallback": function(settings){
                ...
                document.querySelectorAll(".form-textbox-small").forEach(element => {
                        ...
                        $("#tbody").append("<tr > <td colspan='8'></td><td class='text-center' colspan='4'><button type='button' id='stocksubmit' class='btn btn-warning'>Submit</button></td></tr>");
...
function addStock(){
  ...
  document.querySelector("#stocksubmit").innerHTML = `<div class="d-flex justify-content-center align-items-center">
<div class="spinner-border me-1" role="status">
          ...
          document.querySelectorAll("input.add").forEach(element=>{
            temp = {};
            temp["rid"] = <?php echo '222';?>; // write dynamic here for retailer id
      ...
      setTimeout(() => {
        jQuery.post(postTo, data,
              function (data) {
                  ...
                  document.querySelector("#stocksubmit").innerHTML = "Submit";
              }, 'JSON');
      }, 3000);
