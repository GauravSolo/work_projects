...
{
    // $query = "select sum(stockcount) as count , category_tb.type as type, products_tb.sub_category_id as id ,products_tb.category_name as name, products_tb.subcategory_name as subname,products_tb.GST as gst,products_tb.price as price FROM `stock` JOIN  `products_tb` on `products_tb`.`sub_category_id` = `stock`.`service_id` JOIN category_tb on category_tb.category_name = products_tb.category_name  group by `stock`.`service_id` order by count DESC LIMIT 0 , 3";

    $query = "SELECT sum(Stock_Topup_Count) as count, Staff_Sub_Service.Staff_Sub_Service_Id  as id ,`Staff_Sub_Service`.`Sub_Service_Name` as subname,`Staff_Service`.`Service_Name` as name FROM `Stock_Topup`  join `Staff_Sub_Service` on `Staff_Sub_Service`.`Staff_Sub_Service_Id` = `Stock_Topup`.`Staff_Sub_Service_Id`  join `Staff_Service` on `Staff_Service`.`Staff_Service_Id` = `Staff_Sub_Service`.`Staff_Service_Id` where Staff_Sub_Service.Retailer_Id= '$Retailer_Id' and Staff_Sub_Service.Active_Status in (-1,1) and Staff_Service.Category = 1 group by `Stock_Topup`.`Staff_Sub_Service_Id`  order by count DESC LIMIT 0 , 3";
...
{
    // $query = "select sum(stockcount) as count , category_tb.type as type, products_tb.sub_category_id as id ,products_tb.category_name as name, products_tb.subcategory_name as subname,products_tb.GST as gst,products_tb.price as price FROM `stock` JOIN  `products_tb` on `products_tb`.`sub_category_id` = `stock`.`service_id` JOIN category_tb on category_tb.category_name = products_tb.category_name  group by `stock`.`service_id` and stock order by count DESC LIMIT 0 , 3";

    $query = "SELECT sum(Stock_Topup_Count) as count, Staff_Sub_Service.Staff_Sub_Service_Id  as id ,`Staff_Sub_Service`.`Sub_Service_Name` as subname,`Staff_Service`.`Service_Name` as name FROM `Stock_Topup`  join `Staff_Sub_Service` on `Staff_Sub_Service`.`Staff_Sub_Service_Id` = `Stock_Topup`.`Staff_Sub_Service_Id`  join `Staff_Service` on `Staff_Service`.`Staff_Service_Id` = `Staff_Sub_Service`.`Staff_Service_Id` where Staff_Sub_Service.Retailer_Id= '$Retailer_Id' and Staff_Sub_Service.Active_Status in (-1,1) and Staff_Service.Category = 1 and Stock_Topup.Remark LIKE '%damage%' group by `Stock_Topup`.`Staff_Sub_Service_Id` order by count DESC LIMIT 0 , 3";
...
{
    $query = "SELECT sum(Stock_Topup_Count) as count, Staff_Sub_Service.Staff_Sub_Service_Id  as id ,`Staff_Sub_Service`.`Sub_Service_Name` as subname,`Staff_Service`.`Service_Name` as name FROM `Stock_Topup`  join `Staff_Sub_Service` on `Staff_Sub_Service`.`Staff_Sub_Service_Id` = `Stock_Topup`.`Staff_Sub_Service_Id`  join `Staff_Service` on `Staff_Service`.`Staff_Service_Id` = `Staff_Sub_Service`.`Staff_Service_Id` where Staff_Sub_Service.Retailer_Id= '$Retailer_Id' and Staff_Sub_Service.Active_Status in (-1,1) and Staff_Service.Category = 1 and Stock_Topup.Remark LIKE '%internal%' group by `Stock_Topup`.`Staff_Sub_Service_Id`  order by count DESC LIMIT 0 , 3";
...
{
    $query = "SELECT sum(Stock_Topup_Count) as count, Staff_Sub_Service.Staff_Sub_Service_Id  as id ,`Staff_Sub_Service`.`Sub_Service_Name` as subname,`Staff_Service`.`Service_Name` as name FROM `Stock_Topup`  join `Staff_Sub_Service` on `Staff_Sub_Service`.`Staff_Sub_Service_Id` = `Stock_Topup`.`Staff_Sub_Service_Id`  join `Staff_Service` on `Staff_Service`.`Staff_Service_Id` = `Staff_Sub_Service`.`Staff_Service_Id` where Staff_Sub_Service.Retailer_Id= '$Retailer_Id' and Staff_Sub_Service.Active_Status in (-1,1) and Staff_Service.Category = 1 and Stock_Topup.Remark LIKE '%expire%' group by `Stock_Topup`.`Staff_Sub_Service_Id`  order by count DESC LIMIT 0 , 3";
