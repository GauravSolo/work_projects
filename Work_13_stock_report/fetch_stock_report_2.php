...
if($result)
{
    ...
    foreach($rows as $row){
        ...
        $arr["click"] = "<button class='btn btn-sm btn-primary'>click</button>";
...
if(isset($_POST['selling']))
{
    ...
    $query = "SELECT sum(Stock_Topup_Count) as count, Staff_Sub_Service.Staff_Sub_Service_Id  as id ,`Staff_Sub_Service`.`Sub_Service_Name` as subname,`Staff_Service`.`Service_Name` as name FROM `Stock_Topup`  join `Staff_Sub_Service` on `Staff_Sub_Service`.`Staff_Sub_Service_Id` = `Stock_Topup`.`Staff_Sub_Service_Id`  join `Staff_Service` on `Staff_Service`.`Staff_Service_Id` = `Staff_Sub_Service`.`Staff_Service_Id` where Stock_Topup.Type = 0 and Staff_Sub_Service.Retailer_Id= '$Retailer_Id' and Staff_Sub_Service.Active_Status in (-1,1) and Staff_Service.Category = 1  and Stock_Topup.Timestamp >= '$startdate' and Stock_Topup.Timestamp <= '$enddate' group by `Stock_Topup`.`Staff_Sub_Service_Id`  order by count ASC LIMIT 0 , $rowcount";
...
if(isset($_POST['damaged']))
{
    ...
    $query = "SELECT sum(Stock_Topup_Count) as count, Staff_Sub_Service.Staff_Sub_Service_Id  as id ,`Staff_Sub_Service`.`Sub_Service_Name` as subname,`Staff_Service`.`Service_Name` as name FROM `Stock_Topup`  join `Staff_Sub_Service` on `Staff_Sub_Service`.`Staff_Sub_Service_Id` = `Stock_Topup`.`Staff_Sub_Service_Id`  join `Staff_Service` on `Staff_Service`.`Staff_Service_Id` = `Staff_Sub_Service`.`Staff_Service_Id` where Staff_Sub_Service.Retailer_Id= '$Retailer_Id' and Staff_Sub_Service.Active_Status in (-1,1) and Staff_Service.Category = 1 and Stock_Topup.Timestamp >= '$startdate' and Stock_Topup.Timestamp <= '$enddate' and Stock_Topup.Remark LIKE '%damage%' group by `Stock_Topup`.`Staff_Sub_Service_Id` order by count ASC LIMIT 0 , $rowcount";
...
{
    $rowcount = $_POST["rows"];
    $query = "SELECT sum(Stock_Topup_Count) as count, Staff_Sub_Service.Staff_Sub_Service_Id  as id ,`Staff_Sub_Service`.`Sub_Service_Name` as subname,`Staff_Service`.`Service_Name` as name FROM `Stock_Topup`  join `Staff_Sub_Service` on `Staff_Sub_Service`.`Staff_Sub_Service_Id` = `Stock_Topup`.`Staff_Sub_Service_Id`  join `Staff_Service` on `Staff_Service`.`Staff_Service_Id` = `Staff_Sub_Service`.`Staff_Service_Id` where Staff_Sub_Service.Retailer_Id= '$Retailer_Id' and Staff_Sub_Service.Active_Status in (-1,1) and Staff_Service.Category = 1 and Stock_Topup.Timestamp >= '$startdate' and Stock_Topup.Timestamp <= '$enddate' and Stock_Topup.Remark LIKE '%internal%' group by `Stock_Topup`.`Staff_Sub_Service_Id`  order by count ASC LIMIT 0 , $rowcount";
...
{
    $rowcount = $_POST["rows"];
    $query = "SELECT sum(Stock_Topup_Count) as count, Staff_Sub_Service.Staff_Sub_Service_Id  as id ,`Staff_Sub_Service`.`Sub_Service_Name` as subname,`Staff_Service`.`Service_Name` as name FROM `Stock_Topup`  join `Staff_Sub_Service` on `Staff_Sub_Service`.`Staff_Sub_Service_Id` = `Stock_Topup`.`Staff_Sub_Service_Id`  join `Staff_Service` on `Staff_Service`.`Staff_Service_Id` = `Staff_Sub_Service`.`Staff_Service_Id` where Staff_Sub_Service.Retailer_Id= '$Retailer_Id' and Staff_Sub_Service.Active_Status in (-1,1) and Staff_Service.Category = 1 and Stock_Topup.Timestamp >= '$startdate' and Stock_Topup.Timestamp <= '$enddate' and Stock_Topup.Remark LIKE '%expire%' group by `Stock_Topup`.`Staff_Sub_Service_Id`  order by count ASC LIMIT 0 , $rowcount";
